...
// Every role Material3 components actually draw from is set explicitly here - leaving
// one unset falls back to Material3's default purple baseline, which is how the app
// ended up with brand-navy screens next to stock-purple selected chips.
